"""
D-GITALCODE Document Media Extractor Pro - Batch service.
...
class BatchService:
    ...
    def _run(
        ...
        while not self._queue.empty() and not self._cancel_event.is_set():
            ...
            # Self-contained output: reports for this document live inside
            # its own folder and only describe this source file.
            if (
