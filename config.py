"""
================================================================================
D-GITALCODE Document Media Extractor Pro - Application Configuration
================================================================================
...
APP_NAME: Final[str] = "D-GITALCODE Document Media Extractor Pro"
APP_VERSION: Final[str] = "2.0.0"
APP_DISPLAY_VERSION: Final[str] = "v2.0.0"
AUTHOR: Final[str] = "ELKARCH ABDELHAMID"
BRAND: Final[str] = "D-GITALCODE"
COPYRIGHT: Final[str] = f"{BRAND} \u00a9 2026 | Professional Image Extraction Tool"
...
DEFAULT_OUTPUT_PARENT: Final[Path] = APP_DIR / "output"
SETTINGS_FILE: Final[Path] = APP_DIR / "settings.json"
HISTORY_FILE: Final[Path] = LOGS_DIR / "history.json"

OUTPUT_FOLDER_NAME: Final[str] = "Extracted_Images_D-GITALCODE"
